...
class ArticleWithCommentsResponseTest {
    ...
    void givenArticleWithCommentsDtoWithoutChildComments_whenMapping_thenOrganizesCommentsWithCertainOrder() {
        ...
        ArticleWithCommentDto input = createArticleWithCommentsDto(articleCommentDtos);
    ...
    private ArticleWithCommentDto createArticleWithCommentsDto(Set<ArticleCommentDto> articleCommentDtos) {
